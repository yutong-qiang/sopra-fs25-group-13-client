...
| Lorenzo          | 30.03.25 | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/7ebeb07254f72f6788fe9526133b67fb309729be | (#48, #50): Added endpoint for joining a game session and all necessary methods in AppService to do this. | Implements core functionality for the application |
| Lorenzo             | 31.03.25 | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/dc33339456161fc7ebbf6dd48254f4a16340821c | (#49, #149): Regulated access to game session (constraints on status, maximum number of players).| Guarentees correct access to game session, prevents undesired behaviours from users |
...
| Lorenzo | 04.04.25  | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/57688a1ffd7df077467dc2c33e1db31c62bf7950 | (#70) Implemented websockets endpoints| Websockets endpoints are fundamental for the whole game logic for handling player actions |
...
## Contributions Week 4 - [14.04.25] to [27.04.25]
| **Student** | **Date** | **Link to Commit** | **Description** | **Relevance** |
| ------------------ | -------- | ------------------ | ------------------------------- | ----------------------------------- |
...
|          Lorenzo          | 13.04.2025   | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/7cea13abe4f87765ab149dfe41297dfc8cc1483a| (#102, #104, #126, #84, #85, #86, #87) Implementation of actions for starting voting phase and casting the votes.| The voting phase is a pivotal in the game logic.|
| Lorenzo | 15.04.2025 |  https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/476f480ba3f897226ad545133a0e481f05519898|  Fixed WebSocket configuration and restored tests|  Enables WebSocket to work correctly and restores tests needed to ensure correctness|
| Lorenzo | 16.04.2025 | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/94b85a47b9c1bc57586882a80bbd1b2a9e48bdb3, https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/a70cae25d61234a9ce2dc739ba50489e9f808ca4,  | Fixing several issues related that prevented deployment| Deployment issues related to WebSocket (modifying env to flex and other changes) are necessary to make the application work but have no direct correspondence to any dev task. |
| Lorenzo | 15.04.2025 |  https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/476f480ba3f897226ad545133a0e481f05519898|  Fixed WebSocket configuration and restored tests|  Enables WebSocket to work correctly and restores tests needed to ensure correctness|
|          Lorenzo          | 25.04.2025   | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/ba531411d8f6b1041933d94d119c307937080f66
...
| Yutong | 14.05.25 | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/0331e2272a5dfb5b689e91f1ad16978c44b01463 | leaderboard backend implemented | for data persistency |
| Yutong | 13.05.25 | https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/7ac497745c348f8c491f7de0b0a5f2b28eae6a09 | Update users' status after each round. #141 | storing users' game data |
| Lorenzo | 17.05.2025|  https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/f03ea3cdfeaee80edf7d66530f5d0903fe69070f|Allow game admin to start a new game session right after the end of the current game session|Necessary to allow replayability|
| Lorenzo | 17.05.2025| https://github.com/yutong-qiang/sopra-fs25-group-13-server/commit/1310dd8fe05b71b6768c8c6302770634a966ee81|Allows chameleon to give secret word as hint| Necessary to prevent the chameleon from finding out the secret word just by typing it in and seeing the server rejecting it. This ensures fairness in the game.|
